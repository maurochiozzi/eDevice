...
Core/mock/%.o Core/mock/%.su: ../Core/mock/%.c Core/mock/subdir.mk
...
clean: clean-Core-2f-mock

clean-Core-2f-mock:
	-$(RM) ./Core/mock/mock.d ./Core/mock/mock.o ./Core/mock/mock.su

.PHONY: clean-Core-2f-mock
