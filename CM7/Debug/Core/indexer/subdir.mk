...
OBJS += \
./Core/indexer/indexer.o 

C_DEPS += \
./Core/indexer/indexer.d 


# Each subdirectory must supply rules for building sources it contributes
Core/indexer/%.o Core/indexer/%.su: ../Core/indexer/%.c Core/indexer/subdir.mk
...
clean: clean-Core-2f-indexer

clean-Core-2f-indexer:
	-$(RM) ./Core/indexer/indexer.d ./Core/indexer/indexer.o ./Core/indexer/indexer.su

.PHONY: clean-Core-2f-indexer
