...
C_SRCS += \
../Core/beacon/beacon.c 

OBJS += \
./Core/beacon/beacon.o 

C_DEPS += \
./Core/beacon/beacon.d 


# Each subdirectory must supply rules for building sources it contributes
Core/beacon/%.o Core/beacon/%.su: ../Core/beacon/%.c Core/beacon/subdir.mk
...
clean: clean-Core-2f-beacon

clean-Core-2f-beacon:
	-$(RM) ./Core/beacon/beacon.d ./Core/beacon/beacon.o ./Core/beacon/beacon.su

.PHONY: clean-Core-2f-beacon
