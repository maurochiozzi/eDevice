...
C_SRCS += \
../Core/station/station.c 

OBJS += \
./Core/station/station.o 

C_DEPS += \
./Core/station/station.d 


# Each subdirectory must supply rules for building sources it contributes
Core/station/%.o Core/station/%.su: ../Core/station/%.c Core/station/subdir.mk
...
clean: clean-Core-2f-station

clean-Core-2f-station:
	-$(RM) ./Core/station/station.d ./Core/station/station.o ./Core/station/station.su

.PHONY: clean-Core-2f-station
