...
Core/device/%.o Core/device/%.su: ../Core/device/%.c Core/device/subdir.mk
...
clean: clean-Core-2f-device

clean-Core-2f-device:
	-$(RM) ./Core/device/device.d ./Core/device/device.o ./Core/device/device.su

.PHONY: clean-Core-2f-device
