...
C_SRCS += \
../Core/navigation/navigation.c 

OBJS += \
./Core/navigation/navigation.o 

C_DEPS += \
./Core/navigation/navigation.d 


# Each subdirectory must supply rules for building sources it contributes
Core/navigation/%.o Core/navigation/%.su: ../Core/navigation/%.c Core/navigation/subdir.mk
...
clean: clean-Core-2f-navigation

clean-Core-2f-navigation:
	-$(RM) ./Core/navigation/navigation.d ./Core/navigation/navigation.o ./Core/navigation/navigation.su

.PHONY: clean-Core-2f-navigation
